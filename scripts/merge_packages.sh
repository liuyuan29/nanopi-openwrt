...
merge_package "-b packages https://github.com/xiaorouji/openwrt-passwall"
...
merge_package https://github.com/immortalwrt/luci/branches/openwrt-18.06/applications/luci-app-socat
